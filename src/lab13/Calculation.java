package lab13;
/**
 * This class describes the calculation of several functions. 
 * The function can be selected when creating a class object, 
 *  putting into the constructor function number. You see formula in lab #13.
...
public class Calculation {
    ...
    /**
     *  The function can be selected when creating a class object, 
     *  putting into the constructor function number. 
     *  You see formula in lab #13.
     * @param numberEquation - function number
     *
     */
...
/**
 * This method calculates the value of a function depending on the coefficients a, b, c, d
 * @param a - function coefficient;
 * @param b - function coefficient;
 * @param c - function coefficient;
 * @param d - function coefficient;
 ...
 */
	...
	if (numberEquation >= 1 && numberEquation <= 20) {
	    ...
	    System.out.println("Номер уравнения должен быть от 1 до 20");
	}
    }
